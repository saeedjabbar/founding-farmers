...
export interface ApiPrivacyPolicyPrivacyPolicy extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Privacy policy content for the site';
...
export interface ApiRecordRecord extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable archival record referenced by timeline entries';
    displayName: 'Record';
    pluralName: 'records';
    singularName: 'record';
  };
  ...
  attributes: {
    ...
    timelineEntries: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiStandardStandard extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editorial standards and project rules';
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Editorial story with timeline milestones and source records';
    displayName: 'Story';
    pluralName: 'stories';
    singularName: 'story';
  };
...
export interface ApiTimelineEntryTimelineEntry
  ...
  info: {
    description: 'Story milestone with linked source records';
